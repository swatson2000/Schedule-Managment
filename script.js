...
$(document).ready(function() {
    ...
    function updateCurrentTime() {
      ...
      function updateFutureTime1() {
        var futureTime1 = dayjs().format("HH"); // Get the current time in HH:mm:ss format
        var futureTime1Elements = document.querySelectorAll(".future1 .hour"); // Get the elements with class "col-2"
      
        for (var i = 0; i < futureTime1Elements.length; i++) {
          var futureTime1Element = futureTime1Elements[i];
          futureTime1Element.textContent = parseInt(futureTime1) +2;// Set the content of each element to the current time
        }
      }
      ...
      // Call the function every second to continuously update the current time
      setInterval(updateFutureTime1, 1000);
